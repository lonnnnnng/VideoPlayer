...
- 标签构建：`v1.0.2`
- 结果：成功
- Release 产物：`ZYPlayer-v1.0.2.apk`
...
```bash
adb install -r /tmp/zyplayer-release-v1.0.2/ZYPlayer-v1.0.2.apk
