...
ZYPlayer 是一个原生 Android 应用，使用 Kotlin 和 Jetpack Compose 构建。整体分层如下：
...
```text
ZYPlayer/app/src/main/java/com/zy/player/ui
```
...
```text
ZYPlayer/app/src/main/java/com/zy/player/data/repository
```
...
```text
ZYPlayer/app/src/main/java/com/zy/player/data/local/AppDatabase.kt
```
...
```text
ZYPlayer/app/src/main/java/com/zy/player/data/local/DefaultSources.kt
```
...
```text
ZYPlayer/app/src/main/java/com/zy/player/player/PlayerManager.kt
```
...
```text
ZYPlayer/app/src/main/java/com/zy/player/di/AppModule.kt
```
...
- `v1.0.2` -> `VERSION_NAME=1.0.2`
- `v1.0.2` -> `VERSION_CODE=1000002`
